...
class LiquidGlassDampedDragAnimation(
    ...
    val onDragStarted: LiquidGlassDampedDragAnimation.(position: Offset) -> Unit,
    val onDragStopped: LiquidGlassDampedDragAnimation.() -> Unit,
    val onDrag: LiquidGlassDampedDragAnimation.(size: IntSize, dragAmount: Offset) -> Unit,
) {
...
class LiquidGlassInteractiveHighlight(
    private val animationScope: CoroutineScope,
